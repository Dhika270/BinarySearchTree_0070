...
public:
    ...
    void insert()
    {
        ...
        // Step 6: If the value in the data field of new noed is less than that of parent
        if (x < parent->info)
        {
    ...
    {
        // This function searches the currentNode of the specifirf Node as well as the current Node of its parent
        currentNode = ROOT;
        parent = nullptr;
    ...
    void postorder(Node *ptr)
    {
        ...
        postorder(ptr->rightchild); //parent
    }
